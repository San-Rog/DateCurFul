...
def exibInfo():
    ...
    #    st.text("Estou a executar num terminal")
    #else:
    #    st.text("Não estou a executar num terminal")    
    config()
...
def main():
    ...
    with st.container(border=6):  
        ...
        colCal, colFiles, colInfo, colClear = st.columns(4, gap='small', vertical_alignment='center')
        ...
        colInfo.button(label='Informações', use_container_width=True, icon=":material/calculate:", 
